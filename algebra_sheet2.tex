...
\newcommand{\valA}{9} % Hidden value for A
\newcommand{\valB}{9} % Hidden value for B
\newcommand{\valp}{4} % Example value for p, limited to 1-5
\newcommand{\vals}{4} % New example value for s, limited to 1-5
\newcommand{\valq}{2} % Example value for q, limited to 1-5
