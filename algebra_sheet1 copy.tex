...
\newcommand{\valA}{15} % Hidden value for A
\newcommand{\valB}{6}  % Hidden value for B
\newcommand{\valp}{2}  % Example value for p, limited to 1-5
\newcommand{\valq}{5}  % Example value for q, limited to 1-5
\newcommand{\valr}{3}  % Example value for r, limited to 1-5
