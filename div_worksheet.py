...
def generate_division_row(divisor_range, dividend_range):
    ...
    dividend = random.choice([num for num in dividend_range if num % divisor == 0])
    ...
    latex_row = f"\\Huge ${dividend} \\div {divisor}=$ \\raisebox{{-0.25\\height}}{{\\colorbox{{blue!30}}{{\\rule{{0pt}}{{40pt}}\\hspace{{2em}}}}}} & \\Huge ${rounded_dividend} \\div {divisor}=$ \\raisebox{{-0.25\\height}}{{\\colorbox{{blue!30}}{{\\rule{{0pt}}{{40pt}}\\hspace{{2em}}}}}} & \\Huge ${difference} \\div {divisor}=$ \\raisebox{{-0.25\\height}}{{\\colorbox{{blue!30}}{{\\rule{{0pt}}{{40pt}}\\hspace{{2em}}}}}} \\\\ [\\rowheight] \\hline"
...
dividend_range = list(range(100, 1000))
